...
<head>
    ...
    <title>Eco Plan Challenge</title>
    ...
    <style>
        :root {
            ...
            --danger: #c62828;
            --difficult: #7b1fa2;
            --difficult-light: #9c27b0;
            --difficult-dark: #6a1b9a;
        }
        ...
        * {
        ...
        .progress-bar {
            height: 100%;
            background: linear-gradient(90deg, var(--difficult-light), var(--difficult));
        ...
        .next-btn:hover, .submit-btn:hover {
            background-color: var(--difficult-dark);
            transform: translateY(-2px);
...
<body>
    ...
    <div class="game-header">
        <a href="{{ route('dashboard') }}" class="back-btn">
            ...
            <h1>Eco Plan Challenge</h1>
            
            <div class="difficulty-selector">
                <div class="difficulty-btn easy" data-difficulty="easy">Easy</div>
                <div class="difficulty-btn moderate" data-difficulty="moderate">Moderate</div>
                <div class="difficulty-btn difficult active" data-difficulty="difficult">Difficult</div>
            </div>
        ...
        <form id="triviaForm">
            <input type="hidden" name="difficulty" value="difficult" id="difficultyInput">
        ...
        <div class="completion-message d-none" id="completionScreen">
            ...
            <p>You've completed the Difficult level of Eco Plan Challenge!</p>
            ...
            <div class="completion-buttons">
                <button class="btn d-none" id="continueButton">
                    Continue to Expert Level <i class="fas fa-arrow-right"></i>
                </button>
